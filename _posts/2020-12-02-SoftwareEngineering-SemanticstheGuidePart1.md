...
Now things have changed you are on a team and you are in charge of a set of screens that capture your teams domain. 
(Domain being area of expertise and business vertical)

Worst yet you have 5 developers or more and you have to communicate with them since, this deal with the details of your domain no longer just screens and UI. 
...
These techniques should reduce lack of alignment on designs which cost time and interupts.
...
More specifically Software Semantics using Types / Interfaces (protocols) Data Structures

Lets be more specific and talk about some examples build a language using those examples.
...
We `COMBINE`and transform those events and we create to create state to form an implicit state machine.
